...
# Title:CLD1010_ctypes. 
# Created Date: 2025 - 09 - 24
# Last modified date: 2025 - 09 - 24
# Python Version Used: Python 3.13
# Thorlabs Driver Version: 3.1.0
# Notes: This example demonstrates how to control a Thorlabs CLD laser diode controller in Python using CTypes library. 
...
res=lib.TL4000_init(b"USB0::0x1313::0x804F::M00413716::INSTR",1,1,byref(itc_handle))
...
print("LD current is set to: ", current.value)
